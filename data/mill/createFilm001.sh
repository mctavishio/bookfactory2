...
#----------------------------------------------------------------
# SETTINGS
input_dir="../../books_1637367507739/mct_algorithm-1635969788_seed-1637258762_t-1637367507739"  # Replace this by a path to your folder /path/to/your/folder
n_files=48                        # Replace this by a number of images
files=`ls ${input_dir}/page%03d.png | head -${n_files}`  # Change the file type to the correct type of your images
